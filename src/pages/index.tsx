...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`shuttletaxi v1`}</title>

        <meta
          name="description"
          content="Welcome to shuttletaxi v1 - Your gateway to efficient, reliable, and affordable point-to-point shared taxi service. Your journey, simplified."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to shuttletaxi v1 - Your gateway to efficient, reliable, and affordable point-to-point shared taxi service. Your journey, simplified.`}
            </Text>
            <Box
