...
import { getFutureBookingById } from 'apiSdk/future-bookings';
import { FutureBookingInterface } from 'interfaces/future-booking';

function FutureBookingViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('future_booking', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/future-bookings/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Driver Id" text={data?.driver_id} />

                <FormListItem label="Vehicle Id" text={data?.vehicle_id} />

                <FormListItem label="Date Of Travel" text={data?.date_of_travel} />

                <FormListItem label="Time Of Travel" text={data?.time_of_travel} />
              </List>
            </FormWrapper>
          </>
        )}
